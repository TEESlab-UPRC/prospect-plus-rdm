...
class QuestionnaireData extends Seeder{
    public function run(): void{
        ...
        array_map(fn($a) => static::newQ($rdm, $a[0], array_map(fn($i) => $schemes[$i], array_diff(array_keys($schemes), count($a) > 1 ? $a[1] : []))), [    // Add RDM questions ([question, disabled schemes?])
            ...
            ["Does your city's project demonstrate a national investment prioritization process directly supported by existing municipal budgets and/or dedicated national or international funding sources?"],
            ["Does your city's project demonstrate a clear national ownership and national direction on its strategic priorities, with a long-term finance orientation, considering potential options for refinancing or repaying investment (e.g. through energy bills or taxation etc)?"],
            ["Where feasible, does your city's project financing strategy provide for a mix of financial instruments and/or business models to create public-private partnerships, multiple financiers and service providers (e.g. for coordinating and mobilizing resources, sharing associated investment risks etc)?"],
            ["Do public procurement procedures facilitate sustainable energy investments adequately?"],
            ["Are subsidies, tax benefits, or other incentives and obligations(e.g energy savings, EEOs, etc) available for private project investors and lenders?", [0]],
            ...
            ["Are Budgetary Rules for public and regional authorities revised to exclude financing schemes (e.g. EPC) from debt quota obligations?", [0]],
            ...
            ["Are city's own capital requirements (e.g. available city budget) sufficient to implement the financing scheme?", [5]],
            ...
            ["Can your municipality capitalize from lending institutions to support your city's project implementation?"],
            ["Does the city have a history on default on debt?", [0, 3, 5]],
            ["Is the typical nominal bank lending rate relatively low?"],
            ["Is co-financing available and complete detail provided in your city's project proposal budget?"],
            ["Will your city's project utilize other innovative sources, such as levies?"],
            ...
            ["Is the city's cooperation and communication with traditional private actors for SECAP or other investment projects (e.g. banks, utilities, energy providers, etc) sufficient in order to implement the scheme?", [0]],
            ["Is the city's cooperation and communication with non-traditional investment actors (e.g. ESCOs) sufficient to implement the respective scheme?", [0, 3]],
            ...
            ["In case the municipality plans to sub-contract its roles and responsibilities with respect to project implementation, and/or transfer all or part of the necessary proceeds, to a third implementing entity is a clear explanation of the contractual arrangements and/or legal arrangements, including transactional flow and/or flow of information, in place?"],
